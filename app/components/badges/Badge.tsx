  ...
  return (
    <div className="flex items-center justify-center space-x-3 select-none">
      ...
      >
        ...
        >
          <div className="relative flex items-center justify-center w-[120px] h-[125px] bg-[#C7C9D1] rounded-full z-10 overflow-hidden">
        ...
        >
          ...
          />
          <div
            className={`relative flex items-center justify-center w-[120px] h-[125px] rounded-full z-10 overflow-hidden`}
